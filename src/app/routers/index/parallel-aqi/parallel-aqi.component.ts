...
@Component({
  selector: 'ngx-parallel-aqi',
  templateUrl: './parallel-aqi.component.html',
  styleUrls: ['../index.component.css']
})
export class ParallelAqiComponent implements OnInit {
...
lineStyle = {
  ...
  initCharts(){
    ...
    let parallelChart = ec.init(document.getElementById('parallelChart'))
    let parallelChartOption = {
      backgroundColor: '#333',
    legend: {
        bottom: 30,
        data: ['北京', '上海', '广州'],
    ...
    parallelChart.setOption(parallelChartOption);
  }
